...
import time
import torch
from ogura.collect_latin_sequences import PATTERNS, WORD
from ogura.diagnose_validation import align_errors
...
def main():
    ...
    p.add_argument('--font-dir',type=Path,default=ROOT/'corpus/fonts')
