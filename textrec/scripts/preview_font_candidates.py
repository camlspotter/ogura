...
from ogura.textrec.download_training_fonts import font_paths
from ogura.textrec.text_common import ROOT
from ogura.textrec.training.preview import create_preview
from ogura.textrec.training.render import font_characters, Vocabulary


def main():
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument('--font-dir', type=Path, default=(Path(__file__).resolve().parents[2] / 'corpus') / 'fonts')
