...
from ogura.textrec.training.render import RenderParams, Sample, render_sample, font_characters, Vocabulary
...
def main():
    ...
    directory = (Path(__file__).resolve().parents[2] / 'corpus') / 'fonts'
