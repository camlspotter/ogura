...
IVD = CORPUS_ROOT / "unicode/IVD_Sequences-2026-08-03.txt"
SCRIPTS = CORPUS_ROOT / "unicode/Scripts-15.0.0.txt"
SCRIPT_EXTENSIONS = CORPUS_ROOT / "unicode/ScriptExtensions-15.0.0.txt"
...
def main():
    ...
    scanned = 0
    for path in sorted((CORPUS_ROOT / "wikipedia/20231101.ja").glob("*.parquet")):
