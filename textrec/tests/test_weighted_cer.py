import unittest
from ogura.textrec.training.metrics import weighted_edit_distance, edit_distance, batch_totals
...
class WeightedCERTests(unittest.TestCase):
    ...
    def test_evaluator_keeps_standard_metrics_and_ctc_loss(self):
        ...
        from ogura.textrec.training.train import TrainConfig, EpochDataset
        ...
        with patch('ogura.textrec.training.evaluate.decode', return_value=['a “b']):
