...
import torch
from ogura.textrec.diagnose_validation import align_errors, diagnose, main
from ogura.textrec.training.metrics import edit_distance
from ogura.textrec.training.render import Sample, RenderParams, Vocabulary
...
class DiagnosticsTests(unittest.TestCase):
    ...
    def test_cli_real_checkpoint_and_validation_manifest(self):
        from ogura.textrec.training.train import TrainConfig, identity_for, sha256
