...
from ogura.textrec.training.metrics import MetricsLog, add_totals, batch_totals, decode, edit_distance, empty_totals, summary, epoch_eta, format_duration, local_finish_time
...
class WorstSamplesTests(unittest.TestCase):
    def test_rank_by_rate_not_raw_errors_and_limit(self):
        from ogura.textrec.training.metrics import worst_samples
