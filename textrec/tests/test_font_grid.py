...
from ogura.textrec.evaluate_lengths import font_grid_summary, validation_sets
...
class GridTests(unittest.TestCase):
    ...
    def test_grid_rendering_initial_best_and_resume(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch('ogura.textrec.evaluate_lengths.evaluate_sets',side_effect=evaluate_grid),redirect_stdout(io.StringIO()):
