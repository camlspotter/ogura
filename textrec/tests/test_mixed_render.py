...
from ogura.textrec.training.render import (RenderParams, Sample, BatchRenderer, Vocabulary,
    normalized_text, western_runs, western_positions, render_sample, parameters_for_sample)
from ogura.textrec.training.model import make_model, ctc_loss
from ogura.textrec.training.train import TrainConfig, train, sha256, identity_for
from ogura.textrec.training.checkpoint import IdentityMismatch
from ogura.textrec.evaluate_lengths import validation_sets, validation_font_keys, main as evaluate_main
...
class MixedTests(unittest.TestCase):
    def test_routing_fallback_and_preserved_fullwidth(self):
        ...
        with patch('ogura.textrec.training.render.font_characters',
