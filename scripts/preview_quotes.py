...
from ogura.training.render import Sample,RenderParams,render_sample,normalized_text,font_characters
from ogura.training.aliases import CharacterAliases


def main():
    fonts=ROOT/'corpus/fonts';output=ROOT/'datasets/font_candidates/quote-review';output.mkdir(parents=True,exist_ok=True)
