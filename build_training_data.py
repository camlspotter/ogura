...
from ogura.text_common import ROOT, export_plaintext
from ogura.diversity import VERSION
...
def run(module,*args):
    cmd=[sys.executable,"-m","ogura."+module,*map(str,args)]
...
def main():
    ...
    folder=ROOT/'corpus/unicode';folder.mkdir(parents=True,exist_ok=True)
