...
from ogura.training.render import Vocabulary, BatchRenderer, Sample, RenderParams
from ogura.training.train import TrainConfig, train, load_initial_weights, sha256
...
class AliasTests(unittest.TestCase):
    ...
    def test_composed_labels_preserve_original_pixels_and_decode(self):
        from ogura.training.render import render_sample
    ...
    def test_render_original_and_ctc_repetitions(self):
        ...
        with patch('ogura.training.render.render_sample', return_value=Image.new('L', (24,48),255)) as render:
            batch = BatchRenderer(v)([sample])
    ...
    def test_checkpoint_resume_and_export(self):
        with tempfile.TemporaryDirectory() as tmp, redirect_stdout(io.StringIO()):
            ...
            from ogura.evaluate_lengths import main as evaluate_main
