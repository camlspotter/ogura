...
from ogura.collect_latin_sequences import build, excerpts, matched_words, training_article
...
class LatinSequenceCollectionTests(unittest.TestCase):
    ...
    def test_build_repeatable_source_provenance_and_heldout_exclusion(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch('ogura.collect_latin_sequences.download',return_value=(source,'fixture')):
