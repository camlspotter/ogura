import unittest
from ogura.build_english import candidate, prose, statistics
...
class EnglishExtractionTests(unittest.TestCase):
    ...
    def test_build_is_repeatable_and_splits_articles(self):
        ...
        from ogura.build_english import build
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch('ogura.build_english.download', return_value=(corpus, 'test')):
